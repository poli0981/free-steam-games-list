...
<Seo title={t("studios.developersTitle")} description={t("studios.developersSeo")} />

<PageHeader
  title={t("studios.developersTitle")}
  subtitle={games.data
    ? t("studios.developersSubtitle", { count: formatNumber(studios.length) })
    : t("studios.developersSeo")}
/>
